...
import com.yun.ssyx.product.mapper.SkuInfoMapper;
import com.yun.ssyx.product.service.SkuAttrValueService;
import com.yun.ssyx.product.service.SkuImageService;
import com.yun.ssyx.product.service.SkuInfoService;
import com.yun.ssyx.product.service.SkuPosterService;
import com.yun.ssyx.vo.product.SkuInfoQueryVo;
import com.yun.ssyx.vo.product.SkuInfoVo;
import com.yun.ssyx.vo.product.SkuStockLockVo;
...
//        skuInfo.setSkuName(skuInfoVo.getSkuName());
    ...
    //5: 获取销售火爆商品
//    @Override
//    public List<SkuInfo> findSaleMaxSkuInfoList() {
//        Page<SkuInfo> page = new Page<>(1,4);
//        LambdaQueryWrapper<SkuInfo> wrapper = new LambdaQueryWrapper<>();
//        wrapper.orderByDesc(SkuInfo::getSale);
